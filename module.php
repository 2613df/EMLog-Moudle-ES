...
/*function index_t($num){
	...
	?>
	<li style="color: #FF6600;"><a target="_blank" href="<?php echo BLOG_URL; ?>t" style="color: #008000;"><?php echo $row['content'];?></a></li>
	<?php }?>
<?php }**/ ?>
<?php
//widget：日历
...
function widget_search($title){ ?>
	...
	<input name="keyword" class="sr" type="text" placeholder="输完回车即可" x-webkit-speech autofocus />
	</form>
	</ul>
	</li>
<?php } ?>
...
function blog_navi(){
	...
	foreach($navi_cache as $value):
		...
		if($value['url'] == ROLE_ADMIN && (ROLE == ROLE_ADMIN || ROLE == ROLE_WRITER)):
			...
			<a class="button btbg" href="<?php echo BLOG_URL; ?>admin/">系统后台</a>
			<a class="button btbg" href="<?php echo BLOG_URL; ?>admin/?action=logout">登出系统</a>
			<a class="button btbg" href="#"onclick="javascript:alert('Coming soon');" alt="Coming soon">即将上线</a>
			<?php 
			continue;
		endif;
		...
		<!--<li>-->
			<a class="button btbg" href="<?php echo $value['url']; ?>" <?php echo $newtab;?>><?php echo $value['naviname']; ?></a>
			<?php if (!empty($value['children'])) :?>
            <ul class="sub-nav">
...
function blog_comments_post($logid,$ckname,$ckmail,$ckurl,$verifyCode,$allow_remark){
	...
	<div class="comment-post" id="comment-post">
		...
		<form method="post" name="commentform" action="<?php echo BLOG_URL; ?>index.php?action=addcom" id="commentform">
			...
			<p>
				<input type="text" name="comname" maxlength="49" value="<?php echo $ckname; ?>" size="22" tabindex="1" placeholder="不可超过49字符捏" x-webkit-speech />
				<label for="author"><small>萌萌哒昵称（#^_^#一定要填诺）</small></label>
			</p>
			<p>
				<input type="text" name="commail"  maxlength="128"  value="<?php echo $ckmail; ?>" size="22" tabindex="2" placeholder="不可超过128字符捏" x-webkit-speech />
				<label for="email"><small>邮箱小弟（-_-#没有就算捏）</small></label>
			</p>
			<p>
				<input type="text" name="comurl" maxlength="256"  value="<?php echo $ckurl; ?>" size="22" tabindex="3" placeholder="不可超过256字符捏" x-webkit-speech />
				<label for="url"><small>网站~\(≧▽≦)/（-_-#没有就算捏）</small></label>
			</p>
			<?php endif; ?>
			<!--<p><textarea name="comment" id="comment" rows="10" tabindex="4"></textarea></p>-->
			<p><textarea name="comment" rows="10" tabindex="4"></textarea></p>
			<p><?php echo $verifyCode; ?> <input type="submit" value="发表评论" tabindex="6" /></p>
			<!--<p><?php echo $verifyCode; ?> <input type="submit" id="comment_submit" value="发表评论" tabindex="6" /></p>-->
			<!--<a class="button btbg" href="#"onclick="javascript:alert('Coming soon');" alt="Coming soon">发表评论</a>-->
